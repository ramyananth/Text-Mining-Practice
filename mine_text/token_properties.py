...
TLP_NEGATOR_LST = ["no", "nothing", "no body", "no longer", "doesnt", "not", "none", "no one", "nobody", "neither", "nowhere", "never", "cannot", "without", "hardly", "rarely", "scarcely", "barely", "doesn't", "ain't", "ai'nt", "aint", "aren't", "are'nt", "arent", "can't", "ca'nt", "cant", "couldn't", "could'nt", "couldnt", "cudn't", "cud'nt", "cudnt", "didn't", "did'nt", "didnt", "don't", "do'nt", "dont", "hadn't", "had'nt", "hadnt", "hasn't", "has'nt", "hasnt", "haven't", "have'nt", "havent", "isn't", "is'nt", "isnt", "'nt", "nor", "shan't", "sha'nt", "shouldn't", "should'nt", "shudn't", "shud'nt", "wasn't", "was'nt", "wasnt", "weren't", "were'nt", "won't", "wo'nt", "wont", "wouldn't", "would'nt", "wouldnt", "wud'nt", "wudnt", "without","could've been","would've been","should've been","could have been","should have been","would have been"]
...
def tokenLexicalProps(chunk, hr, logger=None): #it comes here
    """ """
